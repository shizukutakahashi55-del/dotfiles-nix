...
-- mouse:272 = left click  -> drag to MOVE the focused window
-- mouse:273 = right click -> drag to RESIZE the focused window (this is your
--             "resize windows with the mouse" bind: hold mainMod, hold right
--             click anywhere on the window, and drag)
...
-- Capturas de Pantalla (Grim + Slurp + Wl-Clipboard)

-- 1. Capturar pantalla completa y copiar al portapapeles
hl.bind("PRINT", hl.dsp.exec_cmd("grim - | wl-copy"))

-- 2. Seleccionar área con el ratón y copiar al portapapeles
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | wl-copy"))

-- 3. Seleccionar área, copiar al portapapeles Y guardar en ~/Pictures/Screenshots
