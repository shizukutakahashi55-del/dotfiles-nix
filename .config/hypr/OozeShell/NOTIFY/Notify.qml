// OozeShell — Popup de aviso simple (solo texto)
// Pensado para dispararse desde un bind de Hyprland vía IPC:
//   qs ipc call notify show "Tu mensaje"
// Se autotematiza con /tmp/matugen-colors.json, igual que Walls/Mpris,
// así no hace falta mantener un CSS de swaync sincronizado a mano.
